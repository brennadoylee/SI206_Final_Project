...
ax.set_title("Number of Tweets per day from the CDC containing #COVID or #coronavirus")
ax.grid()
...
ax.set_xlabel("Dates")
ax.set_ylabel("Number of Tweets")
ax.set_title("Sentiment Analysis of tweets per day from the CDC containing #COVID or #coronavirus")
ax.grid()
